        ...
        <div className="container mx-auto px-4 py-12 md:py-20 max-w-6xl">
            ...
            <div className="text-center mb-16">
                <motion.h1
                    ...
                    className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70 mb-4"
                >
                    Get in Touch
                </motion.h1>
                <motion.p
                ...
                >
                    ...
                    We're here to help you optimize your document workflow.
                </motion.p>
            </div>
                ...
                >
                    <GlassCard className="p-8">
                        ...
                        >
                            ...
                            <input type="hidden" name="_subject" value="New Submission from PDFToolkit Contact Form" />
