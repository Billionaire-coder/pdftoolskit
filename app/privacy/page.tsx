            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
                ...
                <section className="mb-8">
                    <p className="lead text-lg mb-6">
                        At PDFToolkit ("we," "our," or "us"), we are committed to protecting your privacy. This Privacy Policy explains specifically how we collect, use, disclose, and safeguard your information when you visit our website <strong>pdftoolkit.com</strong>. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <ul className="list-disc pl-6 space-y-2 mb-4">
                        ...
                        <li><strong>Advertising Cookies:</strong> We may present third-party advertisements (like Google AdSense) to support our free services. These advertisers may use cookies to serve ads based on your prior visits to our website or other websites. You can opt-out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Google Ad Settings</a>.</li>
                    </ul>
                </section>
