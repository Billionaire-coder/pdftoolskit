    ...
    return (
        <div className="container mx-auto px-4 py-12 lg:py-20 max-w-4xl">
            ...
            <div className="text-center mb-12">
                <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-red-500 to-orange-500 mb-6 shadow-glow">
                ...
                <p className="text-lg text-slate-300 max-w-2xl mx-auto">
                    Secure your PDF files with password encryption. Protect sensitive documents from unauthorized access.
                </p>
            </div>
