    ...
    return (
        <div className="container mx-auto px-4 py-12 lg:py-20 max-w-6xl">
            <div className="text-center mb-12">
                <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 mb-6 shadow-glow">
                ...
                <p className="text-lg text-slate-300 max-w-2xl mx-auto">
                    Select specific pages to extract as separate PDF files.
                </p>
            </div>
