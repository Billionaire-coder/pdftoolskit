    ...
    const handleAddWatermark = async () => {
        ...
        try {
           ...
           */
            ...
            downloadFile(blob, `${baseName}_watermarked.pdf`);
    ...
    return (
        <div className="container mx-auto px-4 py-12 lg:py-20 max-w-6xl">
            <div className="text-center mb-12">
                <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-500 mb-6 shadow-glow">
                ...
                <p className="text-lg text-slate-300 max-w-2xl mx-auto">
                    Drag to place, resize, and style your watermark.
                </p>
            </div>
