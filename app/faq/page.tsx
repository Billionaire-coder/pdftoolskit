...
export default function FAQPage() {
    return (
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            <h1 className="text-4xl font-bold mb-8 text-slate-900 dark:text-white">Frequently Asked Questions</h1>
                ...
                <div className="space-y-12">
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-xl font-semibold mb-2 text-slate-800 dark:text-slate-100">Is PDFToolkit really free?</h3>
                                <p>Yes! PDFToolkit is currently 100% free to use. There are no hidden fees, no credit card required, and no subscription plans. We aim to provide high-quality PDF tools accessible to everyone.</p>
                            </div>
                            <div>
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-xl font-semibold mb-2 text-slate-800 dark:text-slate-100">Can I use PDFToolkit on my phone or tablet?</h3>
