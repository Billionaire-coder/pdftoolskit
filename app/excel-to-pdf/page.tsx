    ...
    return (
        <div className="container mx-auto px-4 py-12 lg:py-20 max-w-4xl">
            ...
            <div className="text-center mb-12">
                <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-green-600 to-teal-500 mb-6 shadow-glow">
                    <FileCode2 className="w-12 h-12 text-white" />
                </div>
                <h1 className="text-3xl md:text-5xl font-heading font-bold gradient-text mb-4">
                    Excel to PDF Converter
                </h1>
                <p className="text-lg text-slate-300 max-w-2xl mx-auto">
                    Convert Excel spreadsheets (XLSX, XLS) to professional PDF documents.
                </p>
            </div>
