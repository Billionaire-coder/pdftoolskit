...
export default function RedactPDFPage() {
    ...
    const handleRedactPDF = async () => {
        ...
        try {
            ...
            downloadFile(blob, `${baseName}_redacted.pdf`);
    ...
    return (
        <div className="container mx-auto px-4 py-12 lg:py-20 max-w-6xl">
            <div className="text-center mb-12">
                <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-gray-800 to-black mb-6 shadow-glow border border-gray-700">
                ...
                <p className="text-lg text-slate-300 max-w-2xl mx-auto">
                    Select the area to redact directly on the document
                </p>
            </div>
