    ...
    return (
        <div className="container mx-auto px-4 py-12 lg:py-20 max-w-4xl">
            <div className="text-center mb-12">
                <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-rose-500 to-orange-600 mb-6 shadow-glow">
                    <ShieldAlert className="w-12 h-12 text-white" />
                </div>
                <h1 className="text-3xl md:text-5xl font-heading font-bold gradient-text mb-4">
                    {t('tools.metadataAuditor')}
                </h1>
                <p className="text-lg text-slate-300 max-w-2xl mx-auto">
                    {t('tools.metadataAuditorDesc')}
                </p>
            </div>
