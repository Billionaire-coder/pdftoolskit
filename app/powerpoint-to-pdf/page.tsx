    ...
    return (
        <div className="container mx-auto px-4 py-12 lg:py-20 max-w-4xl">
            <div className="text-center mb-12">
                <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-red-600 to-orange-600 mb-6 shadow-glow">
                ...
                <p className="text-lg text-slate-300 max-w-2xl mx-auto">
                    Convert PowerPoint presentations (.pptx) to PDF documents.
                    Extracts text and content for easy sharing.
                </p>
            </div>
