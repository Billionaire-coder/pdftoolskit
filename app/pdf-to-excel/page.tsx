...
import { FileSpreadsheet, Download, FileText, Smartphone } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-12 lg:py-20 max-w-4xl">
            ...
            <div className="text-center mb-12">
                ...
                <p className="text-lg text-slate-300 max-w-2xl mx-auto">
                    Convert PDF tables to editable Excel spreadsheets (XLSX). Extract data and preserve structure.
                </p>
            </div>
