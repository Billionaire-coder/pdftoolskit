        ...
        <div className="container mx-auto px-4 py-12 lg:py-20 max-w-6xl">
            ...
            <div className="text-center mb-20">
                <motion.div
                    ...
                    className="inline-flex p-4 rounded-3xl bg-gradient-primary mb-8 shadow-glow"
                >
                ...
                <GlassCard className="p-8 lg:p-12 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-white">{t('about.philosophy.zeroServer.title')}</h2>
                        </div>
                ...
                <GlassCard className="p-8 lg:p-12 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <h2 className="text-2xl font-bold text-white">{t('about.philosophy.speed.title')}</h2>
                        </div>
                        <p className="text-slate-300 mb-6 leading-relaxed">
            ...
            <div className="mb-24">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-white mb-4">{t('about.ai.title')}</h2>
                    <p className="text-slate-400">{t('about.ai.subtitle')}</p>
                </div>
                <div className="grid md:grid-cols-3 gap-6">
                    <GlassCard className="p-6 text-center">
                        <Cpu className="w-10 h-10 text-blue-400 mx-auto mb-4" />
                        <h3 className="text-lg font-bold text-white mb-2">{t('about.ai.local.title')}</h3>
                        <p className="text-sm text-slate-400">{t('about.ai.local.desc')}</p>
                    </GlassCard>
                    <GlassCard className="p-6 text-center">
                        <Lock className="w-10 h-10 text-purple-400 mx-auto mb-4" />
                        <h3 className="text-lg font-bold text-white mb-2">{t('about.ai.training.title')}</h3>
                        <p className="text-sm text-slate-400">{t('about.ai.training.desc')}</p>
                    </GlassCard>
                    <GlassCard className="p-6 text-center">
                        <Globe className="w-10 h-10 text-emerald-400 mx-auto mb-4" />
                        <h3 className="text-lg font-bold text-white mb-2">{t('about.ai.private.title')}</h3>
                        <p className="text-sm text-slate-400">{t('about.ai.private.desc')}</p>
                    </GlassCard>
                </div>
            </div>

            {/* CTA Section */}
            <GlassCard className="p-8 lg:p-12 text-center bg-gradient-to-br from-slate-800/50 to-slate-900/50">
