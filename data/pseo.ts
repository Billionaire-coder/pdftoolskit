...
export const pseoPages: PSEOPage[] = [
    {
        ...
        content: `
            ...
            <h3>Why use PDFToolkit for 200KB compression?</h3>
            <ul>
    ...
    },
    {
        ...
        toolHref: '/merge-pdf',
        content: `
            <p>Ethics and client confidentiality are non-negotiable. Using standard cloud PDF tools for legal work is a risk. PDFToolkit provides a <strong>WASM-powered merger</strong> that runs entirely in your desktop browser—no data is ever uploaded to the cloud.</p>
        `
    },
    {
        slug: 'convert-scanned-pdf-to-word-no-ocr',
        title: 'Convert Scanned PDF to Word (Text Extraction)',
        description: 'Need to get text out of a scan? Our tool extracts text data directly into editable Word documents.',
    ...
    },
    {
        ...
        toolHref: '/rotate-pdf',
        content: `
            <p>Unlike browser viewers that only rotate the view, PDFToolkit <strong>re-writes the PDF file</strong> so it stays rotated on every device.</p>
        `
    },
    {
        ...
        toolHref: '/merge-pdf',
        content: `
            <p>Banking data is private. Don't upload it to a server. PDFToolkit uses <strong>browser-only processing</strong> to combine your statements securely.</p>
        `
    },
    {
    ...
    },
    {
        ...
        toolHref: '/scan-pdf',
        content: `
            <p>Cloud-based scanners often produce blurry or grayish "color" scans. PDFToolkit's <strong>B&W Pro Filter</strong> uses high-contrast binary thresholding to create sharp, professional-grade black and white PDFs directly from your phone camera or webcam.</p>
