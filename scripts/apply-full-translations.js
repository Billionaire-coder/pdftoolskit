...
const enCommon = {
    ...
    "features": {
        "title": "Why Choose PDFToolkit?", "subtitle": "Built with modern web technology to give you the best PDF experience possible.",
    ...
    "footer": {
        ...
        "copyright": "© {{year}} PDFToolkit. All rights reserved. Built with ❤️ for everyone."
    },
    "tools": {
...
const translations = {
    es: {
        ...
        features: {
            title: "¿Por qué elegir PDFToolkit?", subtitle: "Construido con tecnología web moderna para darte la mejor experiencia PDF posible.",
        ...
        footer: {
            ...
            copyright: "© {{year}} PDFToolkit. Todos los derechos reservados."
        },
        tools: {
    ...
    fr: {
        ...
        features: {
            title: "Pourquoi choisir PDFToolkit ?", subtitle: "Technologie web moderne pour la meilleure expérience.",
        ...
        footer: {
            ...
            copyright: "© {{year}} PDFToolkit. Tous droits réservés."
        }
    },
    ur: {
        ...
        features: {
            title: "PDFToolkit کیوں منتخب کریں؟",
        ...
        footer: {
            ...
            copyright: "© {{year}} PDFToolkit. جملہ حقوق محفوظ ہیں۔"
        }
    },
    ...
    tr: {
        ...
        features: {
            title: "Neden PDFToolkit?", subtitle: "En iyi PDF deneyimi için modern web teknolojisi.",
        ...
        footer: { description: "Ücretsiz, hızlı ve güvenli PDF araçları.", tools: "Araçlar", company: "Şirket", privacy: "Gizlilik Politikası", terms: "Kullanım Şartları", contact: "İletişim", copyright: "© {{year}} PDFToolkit. Tüm hakları saklıdır." }
    }
};
