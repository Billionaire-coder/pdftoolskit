    ...
    return (
        <>
            ...
            <motion.button
                ...
                className="fixed bottom-6 left-6 z-40 p-4 rounded-full bg-slate-900 border border-slate-700 shadow-xl text-white hover:scale-110 transition-transform group"
                whileHover={{ rotate: 15 }}
                title="Recent Files"
            >
                <History className="w-6 h-6 text-blue-400" />
                <span className="absolute left-14 top-1/2 -translate-y-1/2 bg-slate-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-slate-700 pointer-events-none">
                    Recent Files
                </span>
            </motion.button>
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed left-0 top-0 bottom-0 w-full max-w-sm bg-slate-900 border-r border-slate-700 z-50 shadow-2xl flex flex-col"
                        >
