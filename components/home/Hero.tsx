                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <div className="text-center">
                            ...
                            <div className="text-sm text-slate-400">{t('stats.tools')}</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-heading font-bold gradient-text mb-2">
                                ∞
                            </div>
                            <div className="text-sm text-slate-400">{t('stats.noLimit')}</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-heading font-bold gradient-text mb-2">
                                100%
                            </div>
                            <div className="text-sm text-slate-400">{t('stats.secure')}</div>
                        </div>
                    </motion.div>
                </div>
            </div>
