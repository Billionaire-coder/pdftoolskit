            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute right-0 top-full mt-2 w-56 max-h-[400px] overflow-y-auto rounded-xl border border-white/10 bg-[#0f172a]/95 backdrop-blur-xl shadow-xl z-50 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent"
                    >
