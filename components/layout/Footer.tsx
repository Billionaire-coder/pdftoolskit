...
import { FileText, Github, Twitter, Mail, Instagram, Heart } from 'lucide-react';
            ...
            <GlassCard className="mx-4 lg:mx-8 p-8 lg:p-12" animate={false}>
                <div className="flex flex-col items-center gap-12">
                    ...
                    <div className="w-full flex flex-col lg:flex-row gap-8 justify-center items-stretch">
                        ...
                        <div className="flex-1 flex flex-col-reverse lg:flex-row gap-8 lg:gap-16 justify-end items-center">
                            ...
                            <div className="flex flex-col items-center lg:items-end gap-3 w-full max-w-xs min-h-[100px] justify-center">
                                {isSubmitted ? (
                                    ...
                                    <>
                                        <h4 className="font-heading font-semibold text-slate-900 dark:text-white text-center lg:text-right w-full">
                            ...
                            <div className="flex flex-col gap-3 text-center lg:text-right items-center lg:items-end min-w-max">
                                <Link
                                    href="/blog"
                        ...
                        <div className="flex-1 flex flex-col justify-center items-center lg:items-start gap-6 text-center lg:text-left pl-0 lg:pl-4">
